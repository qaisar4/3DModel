...
import {
  ...
  import Header from './sampleProject/components/Header';
  import Animated, {
    useAnimatedStyle,
    useSharedValue,
    withSpring,
  ...
  import Trigger from './sampleProject/components/Trigger';
  import Loader from './sampleProject/components/Loader';
  import Shoe from './sampleProject/components/Shoe';
  import {
    Gesture,
    GestureDetector,
          ...
          <ScrollView>
            ...
            <GestureDetector gesture={pan}>
              <Animated.View style={[styles.sliderContainer, animatedStyle]}>
                <Image
                  source={require('./sampleProject/sampleAssets/Slider.png')}
                  style={styles.slider}
                />
              </Animated.View>
            </GestureDetector>
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.ratingContainer}>
                ...
                <Image
                  style={styles.star}
                  source={require('./sampleProject/sampleAssets/Star.png')}
                />
                <Image
                  style={styles.star}
                  source={require('./sampleProject/sampleAssets/Star.png')}
